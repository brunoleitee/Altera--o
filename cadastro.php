  ...
  <form method="post" action="inserir.php">
    ...
    <div class="formcontainer">
      <div class="container">
        ...
        <input class="s-input" type="text" value="<?php echo $_SESSION['cepend']; ?>" placeholder="Entre com o cep..." name="cep" id="cep" maxlength="8">
        ...
        <div class="endereco">
          <select class="select" name="estado" id="estado">
            <option <?php if ($_SESSION['estado'] == 'AC') {
                      echo ("selected");
                    } ?> value="AC">AC</option>
            <option <?php if ($_SESSION['estado'] == 'AL') {
                      echo ("selected");
                    } ?> value="AL">AL</option>
            <option <?php if ($_SESSION['estado'] == 'AP') {
                      echo ("selected");
                    } ?> value="AP">AP</option>
            <option <?php if ($_SESSION['estado'] == 'AM') {
                      echo ("selected");
                    } ?> value="AM">AM</option>
            <option <?php if ($_SESSION['estado'] == 'BA') {
                      echo ("selected");
                    } ?> value="BA">BA</option>
            <option <?php if ($_SESSION['estado'] == 'CE') {
                      echo ("selected");
                    } ?> value="CE">CE</option>
            <option <?php if ($_SESSION['estado'] == 'DF') {
                      echo ("selected");
                    } ?> value="DF">DF</option>
            <option <?php if ($_SESSION['estado'] == 'ES') {
                      echo ("selected");
                    } ?> value="ES">ES</option>
            <option <?php if ($_SESSION['estado'] == 'GO') {
                      echo ("selected");
                    } ?> value="GO">GO</option>
            <option <?php if ($_SESSION['estado'] == 'MA') {
                      echo ("selected");
                    } ?> value="MA">MA</option>
            <option <?php if ($_SESSION['estado'] == 'MT') {
                      echo ("selected");
                    } ?> value="MT">MT</option>
            <option <?php if ($_SESSION['estado'] == 'MS') {
                      echo ("selected");
                    } ?> value="MS">MS</option>
            <option <?php if ($_SESSION['estado'] == 'MG') {
                      echo ("selected");
                    } ?> value="MG">MG</option>
            <option <?php if ($_SESSION['estado'] == 'PA') {
                      echo ("selected");
                    } ?> value="PA">PA</option>
            <option <?php if ($_SESSION['estado'] == 'PB') {
                      echo ("selected");
                    } ?> value="PB">PB</option>
            <option <?php if ($_SESSION['estado'] == 'PR') {
                      echo ("selected");
                    } ?> value="PR">PR</option>
            <option <?php if ($_SESSION['estado'] == 'PE') {
                      echo ("selected");
                    } ?> value="PE">PE</option>
            <option <?php if ($_SESSION['estado'] == 'PI') {
                      echo ("selected");
                    } ?> value="PI">PI</option>
            <option <?php if ($_SESSION['estado'] == 'RJ') {
                      echo ("selected");
                    } ?> value="RJ">RJ</option>
            <option <?php if ($_SESSION['estado'] == 'RN') {
                      echo ("selected");
                    } ?> value="RN">RN</option>
            <option <?php if ($_SESSION['estado'] == 'RS') {
                      echo ("selected");
                    } ?> value="RS">RS</option>
            <option <?php if ($_SESSION['estado'] == 'RO') {
                      echo ("selected");
                    } ?> value="RO">RO</option>
            <option <?php if ($_SESSION['estado'] == 'RR') {
                      echo ("selected");
                    } ?> value="RR">RR</option>
            <option <?php if ($_SESSION['estado'] == 'SC') {
                      echo ("selected");
                    } ?> value="SC">SC</option>
            <option <?php if ($_SESSION['estado'] == 'SP') {
                      echo ("selected");
                    } ?> value="SP">SP</option>
            <option <?php if ($_SESSION['estado'] == 'SE') {
                      echo ("selected");
                    } ?> value="SE">SE</option>
            <option <?php if ($_SESSION['estado'] == 'TO') {
                      echo ("selected");
                    } ?> value="TO">TO</option>
          </select>
